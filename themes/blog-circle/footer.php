    ...
    <?php } ?>
        ...
        ?>
			...
			<div class="powered-text">
				<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'blog-circle' ) ); ?>"><?php
					/* translators: %s: CMS name, i.e. WordPress. */
					printf( esc_html__( 'Proudly powered by %s', 'blog-circle' ), 'WordPress' );
				?></a>
				<span class="sep"> | </span>
				<?php
					/* translators: 1: Theme name, 2: Theme author. */
					printf( esc_html__( 'Theme: %1$s by %2$s.', 'blog-circle' ), 'Blog Circle', '<a href="http://www.candidthemes.com/">Candid Themes</a>' );
				?>
			</div>
			<?php 
